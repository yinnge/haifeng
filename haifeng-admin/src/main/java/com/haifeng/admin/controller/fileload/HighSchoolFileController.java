...
@Validated
@RestController
@RequestMapping("/api/v1/admin/fileload/high")
@RequiredArgsConstructor
@RequireAdminModule("fileload_high")
public class HighSchoolFileController {
     ...
     */
    @PostMapping("/upload")
    @OperationLog(module = "高中文件管理", action = "上传文件")
     ...
     */
    @PutMapping("/{id}")
    @OperationLog(module = "高中文件管理", action = "修改文件信息")
     ...
     */
    @DeleteMapping("/{id}")
    @OperationLog(module = "高中文件管理", action = "删除文件")
