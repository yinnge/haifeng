...
public class SelectionPositionController {
    ...
    @PostMapping("/create")
    @OperationLog(module = "体制内招录", action = "新增选调生岗位")
    public R<Long> create(@Valid @RequestBody SelectionPositionAddDTO dto) {
        return R.ok(selectionPositionService.add(dto));
    }
