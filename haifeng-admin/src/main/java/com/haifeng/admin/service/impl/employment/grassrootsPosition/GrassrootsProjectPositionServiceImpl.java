...
public class GrassrootsProjectPositionServiceImpl implements GrassrootsProjectPositionService {
    ...
    private List<GrassrootsProjectPositionExcelDTO> readExcel(MultipartFile file) {
        ...
        try {
            ...
            for (GrassrootsProjectPositionExcelDTO dto : importList) {
                if (dto.getPositionName() != null) dto.setPositionName(dto.getPositionName().trim());
                if (dto.getYear() != null) dto.setYear(dto.getYear().trim());
                if (dto.getProjectType() != null) dto.setProjectType(dto.getProjectType().trim());
                if (dto.getProvince() != null) dto.setProvince(dto.getProvince().trim());
                if (dto.getServiceType() != null) dto.setServiceType(dto.getServiceType().trim());
