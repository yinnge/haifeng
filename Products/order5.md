...
每个Sheet对应一个JSONB字段，通过"院校名称"关联主表。每个Sheet的列数不同，具体见下表。

| Sheet名称 | JSONB字段 | 字段说明 | Excel表头 |
|-------|----------|----------|--------|
| 班级与宿舍社交 | classDormSocial | 班级与宿舍社交 | 院校名称, 班级管理方式, 宿舍社交建议 |
| 奖助勤贷与权益保障 | financialAid | 奖助勤贷与权益保障 | 院校名称, 奖助学金政策, 勤工俭学岗位, 权益申诉渠道 |
| 生活服务 | lifeServices | 生活服务 | 院校名称, 校园生活服务, 医疗资源, 兼职实习资源 |
| 水电网与宿舍管理 | dormitoryServices | 水电网与宿舍管理 | 院校名称, 水电费缴纳方式, 宿舍规章制度 |
| 校园安全与应急处理 | campusSecurity | 校园安全与应急处理 | 院校名称, 安全设施, 安全规则 |
| 校园活动与竞赛 | campusEvents | 校园活动与竞赛 | 院校名称, 院校品牌活动, 学科与技能竞赛 |
| 校园设施 | campusFacilities | 校园设施 | 院校名称, 教学楼分布, 实验楼与图书馆, 宿舍区与食堂, 生活配套设施 |
| 校园通勤与校外交通 | campusTransportation | 校园通勤与校外交通 | 院校名称, 校内通勤方式, 校外交通情况 |
| 学生组织与社团 | studentOrganizations | 学生组织与社团 | 院校名称, 官方组织, 社团类型 |
| 学习支持资源 | academicSupportResources | 学习支持资源 | 院校名称, 师资力量, 学习场所, 学业帮扶 |
| 医保与心理健康 | healthServices | 医保与心理健康 | 院校名称, 医保报销政策, 心理健康服务 |
| 专业与课程核心信息 | academicGuidance | 专业与课程核心信息 | 院校名称, 专业培养方案说明, 选课系统说明 |
| 转专业限制 | majorTransferConstriction | 转专业限制 | 院校名称, 限制类型, 具体限制说明 |
| 转专业原则 | majorTransferGuidelines | 转专业原则 | 院校名称, 基本申请条件, 申请时间与流程 |

**JSONB Sheet通用规则：**
- 第1列固定为「院校名称」，用于关联主表
- 第2列起为数据列，每个值为逗号分隔的数组
- 每个Sheet的数据列数不同，按实际表头读取
