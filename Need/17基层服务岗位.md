...
### 任务1【完成对基层服务项目岗位表的查询】
接口1：前端分页展示内容
实现分页查询t_grassroots_project_position表的：id,project_type,year,position_name,service_type,organizing_dept,service_unit,province,city,county,position_status

支持模糊查询的字段：position_name,organizing_dept,service_unit
支持精准查询的字段：project_type,year,service_type,province,city,county,position_status
...
### 任务2【完成对社区工作者岗位表的查询】
接口1：前端分页展示内容
实现分页查询t_community_position表的：id,community_name,position_name,supervising_dept,position_type,province,city,position_status

支持模糊查询的字段：position_name,community_name,supervising_dept
支持精准查询的字段：position_type,province,city,position_status
...
### 任务3【完成公益性岗位表的查询】
接口1：前端分页展示内容（不需要登录）
实现分页查询t_public_welfare_position表的id,developing_unit，employing_unit，position_name，position_category，province，city，district,monthly_salary,reg_start_date,reg_end_date,position_status

支持模糊查询的字段：position_name，developing_unit，employing_unit
支持精准查询的字段：position_category,province,city,district,max_service_years,position_status
