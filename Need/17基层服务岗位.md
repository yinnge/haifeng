...
### 任务1【完成对基层服务项目岗位表的查询】
接口1：前端分页展示内容（不需要登录）
实现分页查询t_grassroots_project_position表的：id,project_type,year,position_name,education_requirement,major_requirement,service_type,organizing_dept,service_unit,province,city,county,township,service_period,age_limit,recruitment_count,political_status

支持模糊查询的字段：position_name,organizing_dept,service_unit
支持精准查询的字段：project_type,year,service_type,province,city,county,education_requirement,major_requirement,grad_year_requirement,political_status,position_status
支持判断查询的字段：age_limit
注意这个模糊查询和精准查询是“and”的关系。

接口2：查看详情（需要登录）
根据分页查询的id展示t_grassroots_project_position表的id、project_type、year、position_name、service_type、organizing_dept、service_unit、province、city、county、township、service_period、service_start_date、service_end_date、education_requirement、major_requirement、age_limit、recruitment_count、grad_year_requirement、household_requirement、other_requirement、political_status、exam_content、exam_time、interview_form、monthly_subsidy、social_insurance、housing_info、other_benefits、after_service_policy、can_transfer_to_civil、can_transfer_to_institution、exam_bonus_points、tuition_compensation、postgrad_bonus、reg_start_date、reg_end_date、apply_link、position_status、contact_phone、remark、content

接口3：基层服务项目岗位备考指南（新增）
根据'guide_category'='grassroots'查询t_exam_guide表的id, guide_category, guide_type, title, subtitle, cover_image, icon_class, summary, content, tags, difficulty_level, target_audience, author_name, author_title, is_top, is_recommended, sort_order, view_count, like_count,

接口4：基层服务项目岗位公告表（新增）
根据'notice_category'='grassroots'查询t_notice表的 id, notice_category, notice_type, title, summary, content, province, city, tags, year, source, source_url, publish_date, publish_unit, reg_start_date, reg_end_date, exam_time, recruitment_count, is_top, is_important, view_count



### 任务2【完成对社区工作者岗位表的查询】
接口1：前端分页展示内容（不需要登录）
实现分页查询t_community_position表的：id,community_name,district,position_name,education_requirement,major_requirement,position_type,province,city,age_limit,recruitment_count,work_experience

支持模糊查询的字段：position_name,street_office,community_name,supervising_dept
支持精准查询的字段：position_type,employment_type,province,city,education_requirement,major_requirement,political_status,work_experience,position_status
支持判断查询的字段：age_limit

接口2：查看详情（需要登录）
根据分页查询的id，展示t_community_position表的 street_office, community_name, supervising_dept, district, position_name, position_type, employment_type, province, city, work_location, education_requirement, age_limit, recruitment_count, major_requirement, household_requirement, political_status, work_experience, social_work_cert, community_experience, residence_requirement, salary_range, salary_composition, benefits, exam_content, interview_form, reg_start_date, reg_end_date, exam_time, position_status, apply_link, apply_method, contact_phone, contact_address, remark, content

接口3：社区工作者岗位备考指南（新增）
根据'guide_category'='community'查询t_exam_guide表的id, guide_category, guide_type, title, subtitle, cover_image, icon_class, summary, content, tags, difficulty_level, target_audience, author_name, author_title, is_top, is_recommended, sort_order, view_count, like_count,

接口4：社区工作者岗位公告表（新增）
根据'notice_category'='community'查询t_notice表的 id, notice_category, notice_type, title, summary, content, province, city, tags, year, source, source_url, publish_date, publish_unit, reg_start_date, reg_end_date, exam_time, recruitment_count, is_top, is_important, view_count


### 任务3【完成公益性岗位表的查询】
接口1：前端分页展示内容（不需要登录）
实现分页查询t_public_welfare_position表的id,developing_unit，employing_unit，position_name，position_category，province，city，district,education_requirement,recruitment_count，monthly_salary，contract_period,max_service_years,reg_start_date,reg_end_date

支持模糊查询的字段：position_name，developing_unit，employing_unit
支持精准查询的字段：position_category,province,city,district,education_requirement,target_group,household_requirement,max_service_years,position_status
支持判断查询的字段：age_range


接口2：查看详情（需要登录）
根据分页查询的id查询t_public_welfare_position表的:id, developing_unit, employing_unit, position_name, position_category, work_content, province, city, district, work_location, target_group, education_requirement, age_range, health_requirement, recruitment_count, household_requirement, employment_difficulty_cert, other_requirement, contract_period, is_renewable, max_service_years, monthly_salary, salary_source, subsidy_standard, social_insurance_info, other_benefits, work_schedule, is_shift_work, reg_start_date, reg_end_date, apply_method, apply_address, required_documents, position_status, contact_phone, contact_person, remark, content

接口3：公益性岗位备考指南（新增）
根据'guide_category'='public_welfare'查询t_exam_guide表的id, guide_category, guide_type, title, subtitle, cover_image, icon_class, summary, content, tags, difficulty_level, target_audience, author_name, author_title, is_top, is_recommended, sort_order, view_count, like_count,

接口4：公益性岗位公告表（新增）
根据'notice_category'='public_welfare'查询t_notice表的 id, notice_category, notice_type, title, summary, content, province, city, tags, year, source, source_url, publish_date, publish_unit, reg_start_date, reg_end_date, exam_time, recruitment_count, is_top, is_important, view_count
