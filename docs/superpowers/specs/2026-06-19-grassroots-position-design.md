...
- 精准：project_type, year, service_type, province, city, county, township, education_requirement, major_requirement, grad_year_requirement, political_status, position_status

**列表返回字段：** id, project_type, year, position_name, service_type, organizing_dept, service_unit, province, city, county, township, service_period, education_requirement, major_requirement, age_limit, recruitment_count, grad_year_requirement, position_status, political_status
...
**列表查询字段：**
- 模糊：position_name, street_office, community_name, supervising_dept, district, work_location, major_requirement
- 精准：position_type, employment_type, province, city, education_requirement, political_status, work_experience, position_status
...
**列表查询字段：**
- 模糊：position_name, developing_unit, employing_unit, province, city
- 精准：position_category, province, city, district, education_requirement, position_status, target_group
