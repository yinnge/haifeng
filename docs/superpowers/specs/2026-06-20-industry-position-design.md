...
- 精准（=）：school_type, school_nature, subject, province, city, district, recruitment_count, position_status
- 判断（>=）：age_limit

**列表返回字段：** id, school_name, school_type, school_nature, position_name, subject, recruitment_type, province, city, district, work_experience, recruitment_count, age_limit, salary_range, reg_start_date, reg_end_date, position_status
...
- 精准（=）：institution_type, institution_level, institution_nature, department, position_category, province, city, district, position_status
- 判断（>=）：age_limit

**列表返回字段：** id, institution_name, institution_level, position_name, department, position_category, province, city, district, age_limit, recruitment_count, salary_range, work_experience, position_status
...
**列表查询字段：**
- 模糊（keyword LIKE）：institution_name, position_name
- 精准（=）：institution_category, institution_type, branch_name, position_category, recruitment_type, province, city, position_status
- 判断（>=）：age_limit, salary_min

**列表返回字段：** id, institution_name, institution_category, position_name, position_category, recruitment_type, province, city, age_limit, work_experience, salary_min, salary_max, reg_start_date, reg_end_date, is_remote, work_location, recruitment_count, position_status
