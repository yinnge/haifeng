...
### 任务1【完成对城市主表的查询】
接口1：分页展示城市主表的:id（id不展示）,city_name,province,region,city_intro,college_count,key_college_count,resident_population,gdp。支持根据city_name模糊查询，支持根据province,region精准查询，注意这个模糊查询和精准查询是并列关系。
