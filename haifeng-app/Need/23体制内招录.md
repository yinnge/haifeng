...
支持精准查询的字段：exam_type,position_code,dept_code,min_education,degree_requirement,political_status,exam_category
...
支持精准查询的字段：selection_type,year,province,education_requirement,degree_requirement,political_status,age_limit,position_status
